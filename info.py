...
ADMIN = int(environ.get('ADMIN', '7965786027'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002853745916'))
...
STREAM_URL = environ.get("STREAM_URL", "https://vj-video-player-c1qq.onrender.com/")
